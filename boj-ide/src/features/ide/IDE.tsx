        ...
        <div className="w-[40%] border-r border-slate-800 flex flex-col bg-[#0F1117]">
          <div className="flex items-center gap-6 px-4 py-3 border-b border-slate-800 text-sm font-medium">
            <button 
              ...
              className={`pb-3 -mb-3.5 transition-colors ${activeTab === 'problem' ? 'text-emerald-400 border-b-2 border-emerald-400' : 'text-slate-500 hover:text-slate-300'}`}
            >
              문제 설명
            </button>
            <button 
              onClick={() => setActiveTab('output')}
              className={`pb-3 -mb-3.5 transition-colors ${activeTab === 'output' ? 'text-emerald-400 border-b-2 border-emerald-400' : 'text-slate-500 hover:text-slate-300'}`}
            >
              실행 결과
            </button>
          </div>
