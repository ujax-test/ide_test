          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[1, 2, 3, 4].map((i) => (
                  <Card key={i} className="p-5 group hover:border-emerald-500/50 transition-all cursor-pointer bg-[#141820]">
            ...
            <section>
              ...
              <div className="space-y-3">
                {[1, 2, 3].map((i) => (
                  <Card key={i} className="p-4 flex items-center justify-between hover:bg-slate-800/50 transition-colors cursor-pointer bg-[#141820]">
          ...
          <div className="space-y-8">
            <section>
              ...
              <Card className="divide-y divide-slate-800 bg-[#141820]">
                {[1, 2, 3, 4, 5].map((rank) => (
                  <div key={rank} className="p-4 flex items-center gap-4 hover:bg-slate-800/30 transition-colors">
