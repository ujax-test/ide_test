        ...
        <div className="p-6 border-b border-slate-800">
          ...
          <div className="relative mb-3">
            ...
            <input 
              ...
              className="w-full h-10 bg-slate-900 border border-slate-800 rounded-lg pl-10 pr-4 text-sm text-slate-200 focus:outline-none focus:border-emerald-500 transition-colors"
            />
          </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {solutions.map((sol) => (
            <div 
              ...
              className={`p-5 border-b border-slate-800/50 cursor-pointer transition-all hover:bg-slate-800/30 ${
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1 relative">
                <input 
                  ...
                  className="w-full bg-slate-900 border border-slate-800 rounded-lg py-2.5 pl-4 pr-12 text-sm text-slate-200 focus:outline-none focus:border-emerald-500 transition-colors"
                />
