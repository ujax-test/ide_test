...
import { User, Lock, Bell, Shield, Trash2, ArrowLeft } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-64 space-y-1">
            {tabs.map((tab) => (<button key={tab.id} onClick={() => setActiveTab(tab.id)} className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${activeTab === tab.id
          ...
          <div className="flex-1">
            <Card className="p-6 bg-[#141820] border-slate-800 min-h-[400px]">
              ...
              {/* Membership Tab */}
              {activeTab === 'membership' && (<div className="space-y-8">
                  <div>
