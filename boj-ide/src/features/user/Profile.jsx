...
import { Settings, MapPin, Link as LinkIcon, Twitter, Github, Flame, CheckCircle2, Coins, CalendarDays, Edit2 } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card className="p-8 bg-[#141820] border-slate-800 relative overflow-hidden">
          ...
          <div className="mt-8 pt-8 border-t border-slate-800">
            ...
            <div className="w-full h-2 bg-slate-800 rounded-full overflow-hidden">
              <div className="h-full bg-emerald-500" style={{ width: `${(user.xp / user.nextLevelXp) * 100}%` }}></div>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6 bg-[#141820] border-slate-800">
          ...
          <div className="flex items-end justify-between h-32 gap-2">
            {activity.map((item, idx) => (<div key={idx} className="flex-1 flex flex-col items-center gap-2 group">
                <div className="w-full bg-emerald-500/20 rounded-t-sm hover:bg-emerald-500/50 transition-colors relative" style={{ height: `${(item.count / 60) * 100}%` }}>
